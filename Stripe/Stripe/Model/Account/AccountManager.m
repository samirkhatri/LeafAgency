...
#import "CAccount.h"
NSString *kActiveUserKey = @"EncodedActivePassionlatinosUser";
...
-(NSString*)accountFilename
{
    ...
    return [documentsPath stringByAppendingPathComponent:@"CAccount.dat"];
}
...
-(void)saveAccount
{
    ...
    if (_activeAccount)
    {
        [_savedAccounts setObject:_activeAccount forKey:_activeAccount.email];
        [self saveAccounts];
    }
...
-(void)setActiveAccount:(CAccount *)activeAccount
{
